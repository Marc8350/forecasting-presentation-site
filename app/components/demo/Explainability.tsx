  ...
  return (
    <div className="stage-screen">
      ...
      <div className="stage-grid explain-layout">
        <div className="product-card explain-image-card"><div className="card-title"><div><span className="card-icon">↗</span><h4>Top drivers · {state.selectedProduct}</h4></div><span>Mean |SHAP|</span></div><img src="/assets/evidence/seed-treatment.png" alt="Feature importance chart for the seed treatment LightGBM model" /></div>
